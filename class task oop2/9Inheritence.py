...
# Example Usage
person = Person("Maruf", "Don")
student = Student("Jon", "Smith", 2024)
alumni = Alumni("Boby", "Boni", 2020, 2021)
current_student = CurrentStudent("Sanny", "Davis", 2025, "10th")
teacher = Teacher("vaan", "Evans", 1234, 2018)
